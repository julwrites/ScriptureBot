...
def keys():
    return [
        LIFE_ISSUES_ANGER_KEY, LIFE_ISSUES_SIN_KEY, LIFE_ISSUES_DEPRESSION_KEY,
        LIFE_ISSUES_GUILT_KEY, LIFE_ISSUES_GODSWILL_KEY, LIFE_ISSUES_LOVE_KEY,
        LIFE_ISSUES_MONEY_KEY, LIFE_ISSUES_PERFECTIONISM_KEY,
        LIFE_ISSUES_SELFIMAGE_KEY, LIFE_ISSUES_SEX_KEY, LIFE_ISSUES_STRESS_KEY,
...
SIN_ALIASES = [
    "Sin", "Wrong", "Wrongdoing", "Disobedience", "Sinful", "Wickedness"
]
SIN_PACK = [
...
DEPRESSION_ALIASES = [
    "Depression", "Depressed", "Depressing", "Sadness", "Sad", "Sorrow",
    "Fear", "Despair"
]
DEPRESSION_PACK = [
    TMSVerse(LIFE_ISSUES_DEPRESSION_KEY, "Depression", 1, "Isaiah 43 : 1 - 3",
             ["Fear", "With", "Overwhelm", "Consume"]),
    TMSVerse(LIFE_ISSUES_DEPRESSION_KEY, "Depression", 2,
    ...
    TMSVerse(LIFE_ISSUES_DEPRESSION_KEY, "Depression", 5,
             "Lamentations 3 : 19 - 23",
             ["Affliction", "Soul", "Steadfast", "Love", "Lord God"]),
    TMSVerse(LIFE_ISSUES_DEPRESSION_KEY, "Depression", 6,
             "2 Corinthians 1 : 8 - 9",
             ["Affliction", "Burden", "Rely", "Lord God"])
]

GUILT_ALIASES = [
    "Guilt", "Guilty", "Conscience", "Forgive", "Forgiveness", "Forgiven"
]
GUILT_PACK = [
...
GODSWILL_ALIASES = [
    "God's Will", "Will of God", "Will", "Sovereignty", "God's Plan",
    "Lord God"
]
GODSWILL_PACK = [
    ...
    TMSVerse(LIFE_ISSUES_GODSWILL_KEY, "God's Will", 4, "Isaiah 30 : 21",
             ["Hear", "Word", "Walk", "Turn"]),
    TMSVerse(LIFE_ISSUES_GODSWILL_KEY, "God's Will", 5,
             "Jeremiah 29 : 11 - 13",
...
LOVE_PACK = [
    ...
    TMSVerse(LIFE_ISSUES_LOVE_KEY, "Love", 5, "1 Corinthians 13 : 4 - 8", [
        "Patient", "Kind", "Envy", "Boasting", "Arrogance", "Rude", "Truth",
        "Irritation", "Resentment", "Hope", "Endures"
    ]),
...
MONEY_ALIASES = [
    "Money", "Wealth", "Riches", "Rich", "Wealthy", "Prosperous", "Treasure"
]
MONEY_PACK = [
...
PERFECTIONISM_ALIASES = [
    "Perfectionism", "Perfect", "Perfection", "Salvation", "Achievements",
    "Grace"
]
PERFECTIONISM_PACK = [
    TMSVerse(LIFE_ISSUES_PERFECTIONISM_KEY, "Perfectionism", 1,
             "Psalm 127 : 1 - 2", PERFECTIONISM_ALIASES),
    TMSVerse(LIFE_ISSUES_PERFECTIONISM_KEY, "Perfectionism", 2,
             "Ecclesiastes 2 : 10 - 11", PERFECTIONISM_ALIASES),
    TMSVerse(LIFE_ISSUES_PERFECTIONISM_KEY, "Perfectionism", 3,
             "Luke 10 : 40 - 42", PERFECTIONISM_ALIASES),
    TMSVerse(LIFE_ISSUES_PERFECTIONISM_KEY, "Perfectionism", 4,
             "2 Corinthians 12 : 9", PERFECTIONISM_ALIASES),
    TMSVerse(LIFE_ISSUES_PERFECTIONISM_KEY, "Perfectionism", 5,
             "Galatians 3 : 3", PERFECTIONISM_ALIASES),
    TMSVerse(LIFE_ISSUES_PERFECTIONISM_KEY, "Perfectionism", 6,
             "Ephesians 2 : 8 - 9", PERFECTIONISM_ALIASES)
]

SELFIMAGE_ALIASES = [
    "Self Image", "Self", "Self Worth", "Self Esteem", "Confidence",
    "Self Pity"
]
SELFIMAGE_PACK = [
    ...
    TMSVerse(LIFE_ISSUES_SELFIMAGE_KEY, "Self-Image", 2, "Psalm 139 : 13 - 14",
             SELFIMAGE_ALIASES),
    TMSVerse(LIFE_ISSUES_SELFIMAGE_KEY, "Self-Image", 3,
             "Jeremiah 9 : 23 - 24", SELFIMAGE_ALIASES),
    TMSVerse(LIFE_ISSUES_SELFIMAGE_KEY, "Self-Image", 4,
             "Matthew 10 : 29 - 31", SELFIMAGE_ALIASES),
    TMSVerse(LIFE_ISSUES_SELFIMAGE_KEY, "Self-Image", 5,
             "Philippians 2 : 3 - 11", SELFIMAGE_ALIASES),
    TMSVerse(LIFE_ISSUES_SELFIMAGE_KEY, "Self-Image", 6, "1 Peter 3 : 3 - 4",
             SELFIMAGE_ALIASES)
]

SEX_ALIASES = [
    "Sex", "Sexuality", "Body", "Intimacy", "Physical Intimacy", "Intimate"
]
SEX_PACK = [
...
STRESS_ALIASES = [
    "Stress", "Stressful", "Pressure", "Burden", "Worry", "Anxiety"
]
STRESS_PACK = [
...
SUFFERING_ALIASES = [
    "Suffering", "Suffer", "Pain", "Enduring", "Agony", "Comfort"
]
SUFFERING_PACK = [
    TMSVerse(LIFE_ISSUES_SUFFERING_KEY, "Suffering", 1, "Romans 5 : 2 - 5",
             SUFFERING_ALIASES),
    TMSVerse(LIFE_ISSUES_SUFFERING_KEY, "Suffering", 2,
             "2 Corinthians 1 : 3 - 4", SUFFERING_ALIASES),
