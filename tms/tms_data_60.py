...
E_PACK = [
    ...
    TMSVerse(TMS_E_KEY, "Honesty", 8, "Acts 24 : 16",
             ["Conscience", "Honesty", "Integrity", "Lord God"]),
    TMSVerse(TMS_E_KEY, "Faith", 9, "Hebrews 11 : 6",
             ["Lord God", "Believe", "Seek", "Faith"]),
    TMSVerse(TMS_E_KEY, "Faith", 10, "Romans 4 : 20 - 21",
             ["Unbelief", "Faith", "Lord God", "Promise"]),
...
def aliases():
    return {
        TMS_A_KEY: ["A", "A Pack", "TMS A", "Living the New Life"],
        TMS_B_KEY: ["B", "B Pack", "TMS B", "Proclaiming Christ"],
        TMS_C_KEY: ["C", "C Pack", "TMS C", "Reliance on God's Resources"],
        TMS_D_KEY: ["D", "D Pack", "TMS D", "Being Christ's Disciple"],
        TMS_E_KEY: ["E", "E Pack", "TMS E", "Growth in Christlikeness"]
    }
